...
class StanfordCars(Dataset):
    def __init__(self, root, min_samples=3, max_samples=None, refined_cls=False, transform=None, augmentation=None,
        ...
        """Parameters:
            ...
            refined_cls (bool, optional): Whether to use refined class labels.
        ...
        if refined_cls:
            self.df = pd.read_csv(os.path.join(self.root, "sc_train_refined.csv"), nrows=data_amount)
        else:
